...
{
    public class TobiArtFair2018Model : PageModel
    {
        ...
        public TobiArtFair2018Model(IArtPieceRepository artPieceRepository)
        {
            this.artPieceRepository = artPieceRepository;
            this.Exhibition = Models.Models.Exhibition.TobiArtFair2018;
        }
